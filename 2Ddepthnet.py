...
def max_pool(bottom, ks, stride=1):
    return L.Pooling(bottom, pool=P.Pooling.MAX, kernel_size=ks,kernel_h=1, stride=stride)
...
def caffenet(data, train=True, num_classes=1000,
    ...
    if train:
        ...
        n.data, n.label=L.HDF5Data(batch_size=1000,source=data,ntop=2)
        #n.label=None
    ...
    n.pool1 = max_pool(n.relu1_2, 2, stride=2)   #112
    ...
    n.pool2 = max_pool(n.relu2_2, 2, stride=2)  #56
    ...
    n.pool3 = max_pool(n.relu3_2, 2, stride=2)   #28
    ...
    n.pool4 = max_pool(n.relu4_3,4,stride=4)  #7
    
    n.fc5, n.relu5 = conv_relu(n.pool4, 7, 4096, pad=0, group=1, param=param)
    

    if train:        
        n.drop5 = fc6input = L.Dropout(n.relu5,dropout_ratio=0.3,in_place=True)
    else:
        fc6input = n.relu5
    ...
    if train:        
        n.drop6 = Deconvinput5 = L.Dropout(n.relu6,dropout_ratio=0.3,in_place=True)
    else:
    ...
    n.deconv5=L.Deconvolution(Deconvinput5,
                              convolution_param=dict(kernel_size=7,stride=7,num_output=256,pad_w=0,pad_h=0,group=1,
    ...
    n.deconv4=L.Deconvolution(n.fused_pool4,
                              convolution_param=dict(kernel_size=4,stride=4,num_output=256,pad_w=0,pad_h=0,group=1,
                                                     weight_filler=dict(type='gaussian', std=0.01),
                                                     bias_filler=dict(type='constant', value=0)),
                              param=param)    # 28                         
    ...
    n.fused_pool1=L.Eltwise(n.deconv2,n.conv2_2) # 112
    ...
    n.fused_pool0=L.Eltwise(n.deconv1,n.conv1_2) # 224    
