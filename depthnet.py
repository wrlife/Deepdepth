...
def caffenet(data, train=True, num_classes=1000,
    ...
    n.conv1, n.relu1 = conv_relu(n.data, 3,32, pad=1, param=param)
    n.pool1 = max_pool(n.relu1, 2, stride=2)
    n.norm1 = L.LRN(n.pool1, local_size=5, alpha=1e-4, beta=0.75)
    n.conv2, n.relu2 = conv_relu(n.norm1, 3, 64,stride=1, pad=1, group=2, param=param)
    n.pool2 = max_pool(n.relu2, 2, stride=2)
    n.norm2 = L.LRN(n.pool2, local_size=5, alpha=1e-4, beta=0.75)
    n.conv3, n.relu3 = conv_relu(n.norm2, 3, 64, pad=1, group=2, param=param)
    n.conv4, n.relu4 = conv_relu(n.relu3, 3, 128,stride=1, pad=1, group=2, param=param)
    n.conv5, n.relu5 = conv_relu(n.relu4, 3, 256, pad=1, group=2, param=param)
    n.pool5 = max_pool(n.relu5, 2, stride=2)
    n.norm5 = L.LRN(n.pool5, local_size=5, alpha=1e-4, beta=0.75)
    n.conv6, n.relu6 = conv_relu(n.norm5, 3, 256,stride=1, pad=1, group=1, param=param)    
    
    
    n.deconv4=L.Deconvolution(n.relu6,
                              convolution_param=dict(kernel_w=2,kernel_h=1,stride=2,num_output=128,pad_w=0,pad_h=0,group=2,
...
#    n.__setattr__(classifier_name, fc8)
    if not train:
        n.probs = L.Power(n.deconv0)
    if n.label is not None:
        n.loss = L.EuclideanLoss(n.deconv0, n.label,loss_weight=0.5)
        n.acc = L.Accuracy(n.deconv0, n.label)
